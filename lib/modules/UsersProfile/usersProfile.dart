...
class UsersProfile extends StatelessWidget {
  UsersProfile({Key? key, required this.userUid}) : super(key: key);
  late UserModel user;
  String userUid;
  Map numberToMonth = {
    1: 'Jan',
  ...
  Widget build(BuildContext context) {
    if (userUid == SocialCubit.get(context).user!.uId) {
      user = SocialCubit.get(context).user!;
    } else {
      SocialCubit.get(context).users.forEach((element) {
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () {
                  SocialCubit.get(context).myPosts = null;
